...
- Run Python library: `cd packages/data-processor && python3 -c "from src.data_processor.pipeline import Record, transform; print(transform([Record(index=1, value='hello')]))"`
